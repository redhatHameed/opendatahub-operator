...
func (s *componentHandler) NewComponentReconciler(ctx context.Context, mgr ctrl.Manager) error {
	_, err := reconciler.ReconcilerFor(mgr, &componentApi.FeatureStore{}).
		...
		Watches(
			...
			reconciler.WithEventHandler(handlers.ToNamed(componentApi.FeatureStoreComponentName)),
		...
		Watches(
			...
			reconciler.WithEventHandler(
				handlers.ToNamed(componentApi.FeatureStoreInstanceName)),
